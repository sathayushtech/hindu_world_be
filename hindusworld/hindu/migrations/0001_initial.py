    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_site', models.CharField(choices=[('MANDAL', 'M'), ('BLOCK', 'B'), ('VILLAGE', 'V'), ('DISTRICT', 'D'), ('STATE', 'S'), ('COUNTRY', 'C'), ('CONTINENT', 'CO')], default='D', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='districts', to='hindu.state')),
            ],
            options={
                'db_table': 'district',
                'managed': True,
