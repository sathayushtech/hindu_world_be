# Generated by Django 5.0.6 on 2024-09-21 05:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='name', max_length=45)),
                ('desc', models.CharField(db_column='desc', max_length=10000)),
                ('category', models.ForeignKey(blank=True, db_column='category', null=True, on_delete=django.db.models.deletion.SET_NULL, to='hindu.trainingcategory')),
            ],
            options={
                'db_table': 'training_sub_category',
                'managed': True,
            },
        ),
        migrations.CreateModel(
