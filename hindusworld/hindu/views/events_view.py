...
#         if page is not None:
#             serializer = EventsSerializer1(page, many=True)
...
#         serializer = EventsSerializer1(event_instance)
#         return Response(serializer.data)

#     def update(self, request, pk=None):
#         instance = self.get_object()
#         serializer = EventsSerializer(instance, data=request.data)
#         serializer.is_valid(raise_exception=True)
#         updated_instance = serializer.save()
#         return Response({
#             "message": "Updated successfully",
#             "data": EventsSerializer1(updated_instance).data
#         })
